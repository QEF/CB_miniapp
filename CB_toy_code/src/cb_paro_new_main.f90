PROGRAM cb_paro_main
  ...
  CALL print_clock('rotHSwk')        ; CALL print_clock('protHSwk')
  CALL print_clock('rotHSwk:hpsi')   ; CALL print_clock('protHSwk:hpsi')
  CALL print_clock('rotHSwk:hc')     ; CALL print_clock('protHSwk:hc')
  CALL print_clock('rotHSwk:diag')   ; CALL print_clock('protHSwk:diag')
  CALL print_clock('rotHSwk:evc')    ; CALL print_clock('protHSwk:evc')
